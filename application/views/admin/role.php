                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('Admin/roleaccess/') . $r['id']; ?>"
                                class="badge badge-primary">Access</a>
                            <a href="#" class="badge badge-success">Edit</a>
                            <?php if ($r['role'] == 'administrator') : ?>
                            <?php elseif ($r['role'] == 'member') : ?>
                            <?php else : ?>
                                    <a href="<?= base_url(); ?>Admin/roledelete/<?= $r['id']; ?>" class="badge badge-danger disabled" onclick="return confirm('Are you sure');">Delete</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php $i++; ?>
